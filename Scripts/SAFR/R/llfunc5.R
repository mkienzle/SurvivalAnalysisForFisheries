...
llfunc5 <- function(par, catch, effort, catchability.scaling.factor){
    # for some reason, optim investigate negative values of par
    ...
    M <- par[2]
    selectivity.at.age <- c(par[-c(1,2)], rep(1,2))
