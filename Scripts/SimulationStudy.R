...
compare.estimates <- rbind(compare.estimates, data.frame(
    ...
    Catchability.est = tmp0$optimization$par[1] * tmp1$optimization$catchability.scaling.factor,
    Catchability.error = tmp0$uncertainties[1] * tmp1$optimization$catchability.scaling.factor,
