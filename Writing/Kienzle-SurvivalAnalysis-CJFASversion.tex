...
\begin{abstract}
\input{abstract.tex}
\keywords{survival analysis, maximum likelihood, age data, natural mortality, catchability, sea mullet}
\end{abstract}

%\begin{resume}
%WRITE ABSTRACT IN FRENCH
%\end{resume}
\maketitle
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\subsection{The likelihood for constant natural and fishing mortality rates} 
           \input{ConstantNaturalAndFishingMortality-CJFASformat.tex}

\subsection{Estimating catchability and natural mortality}
           \input{EstimatingQandM-CJFASformat.tex}
...
%% Bibliography
\input{Kienzle-SurvivalAnalysis.bbl}
